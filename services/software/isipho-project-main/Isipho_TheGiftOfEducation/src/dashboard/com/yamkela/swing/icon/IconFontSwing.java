package dashboard.com.yamkela.swing.icon;
...
public final class IconFontSwing {
    ...
    public static synchronized Font buildFont(String fontFamily) {
        //try {
            for (Iterator <IconFont> it = IconFontSwing.fonts.iterator(); it.hasNext();) {
                
                IconFont iconFont = it.next();
...
//                        return Font.createFont(Font.TRUETYPE_FONT, iconFont.getFontInputStream());
                        ...
                        Logger.getLogger(IconFontSwing.class.getName()).log(Level.SEVERE, null, ex);
