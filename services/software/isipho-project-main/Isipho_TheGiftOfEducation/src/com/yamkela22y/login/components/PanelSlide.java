...
import com.yamkela22y.dashboard.Main;
import static com.yamkela22y.login.authenticator.Login.authenticate;
...
//                login.clear();                      //Clear the login text fields before the loading form is visible.
//                loading.setVisible(false);      //Hides the loading form 
//                login.setVisible(true);         //Shows the login form with null text feilds.
    ...
    private void login(String userName, String password) {
        th = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try{
                    Thread.sleep(2000);
                    if ("yamkela".equals(userName) && "123".equals(password)){
                        
                        Icon  profile;
                        profile = new ImageIcon(getClass().getResource("/com/yamkela/login/icon/profile.jpg"));
                        ModelUser data = new ModelUser(1, userName, profile);
